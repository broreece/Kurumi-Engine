...
public sealed class ForceMoveParty : ScriptStep 
{
    ...
    public ForceMoveParty(bool keepDirection, bool instant, float movementSpeed, List<int> path) : base() 
    {
    ...
    public override void Activate(ScriptContext scriptContext) 
    {
        ...
        _finishableController = mapNavigationActions.ForceMoveParty(_keepDirection, _instant, _movementSpeed, _path);
    }
